...
#define NAME "SuperLogs: CSGO"
#define VERSION "1.2.5"

#define MAX_LOG_WEAPONS 36
...
new const String:g_weapon_list[MAX_LOG_WEAPONS][MAX_WEAPON_LEN]= {
	"r8", "ak47", "aug", "bizon", "deagle", "awp", "elite", "famas", "fiveseven", "cz75a",
	"g3sg1", "galilar", "glock", "hkp2000", "usp_silencer", "m249", "m4a1",
	"mac10", "mag7", "mp7", "mp9", "negev", "nova", "p250", "p90", "sawedoff",
